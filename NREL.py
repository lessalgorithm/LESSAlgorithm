...
# dataset_list = ['NYCTotal']
# dataset_list = ['7_days_NYCTotal']
...
# solar_panel_active_area_m2 = 0.001 # 0.002 has been standard for testing (20cm2)
...
initial_battery_capacity_mah = 5 # 4mah = For TI Tag, this is 24hours in darkness 4 maH
